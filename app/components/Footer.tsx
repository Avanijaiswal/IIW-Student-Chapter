...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-black rounded-t-[60px] px-6 py-20 mt-32">
  ...
  <div className="flex gap-4">
    <a href="tel:+919724232269" className="hover:text-red-500 transition-colors">
      +91 97242 32269
    </a>
    ...
    +91 63533 62642
        ...
        {/* Bottom Section */}
        {/* Bottom Section */}
<div className="border-t border-gray-200 mt-20 pt-10 flex flex-col items-center justify-center gap-6 text-sm text-gray-500">
